import"./chunk-GITKYEDM.js";import{a as o}from"./chunk-YJ2DKIZS.js";var N=`<form id="character-form" class="my-4 overflow-x-hidden lg:overflow-x-auto">
...
`),de=({title:l,options:a})=>b`<div class="flex flex-col">
    <label
      id="title"
      for="${l}"
...
`;var O=class extends HTMLElement{constructor(){super();o(this,"hydrate",e=>{this.querySelector("#gear-list").value=e.gear||[],this.querySelector("#load").value=e.load||0,this.querySelector("#max-load").value=e.maxLoad||0})}onUpdate(e){s.gear=e.detail}connectedCallback(){this.render(),s.subscribe(this.hydrate),this.querySelector("#gear-list").addEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").addEventListener("change",e=>{s.load=e.target.value}),this.querySelector("#max-load").addEventListener("change",e=>{s.maxLoad=e.target.value})}disconnectedCallback(){s.unsubscribe(this.hydrate),this.querySelector("#gear-list").removeEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").removeEventListener("change",e=>{s.load=e.target.value}),this.querySelector("#max-load").removeEventListener("change",e=>{s.maxLoad=e.target.value})}render(){this.innerHTML=Z}};customElements.define("dw-character-gear",O);var A=class extends HTMLElement{constructor(){super();o(this,"_characterClass");o(this,"_value",{})}get value(){return this._value}set value(e){this._value=e,this.updateDom()}updateDom(){let e=this.firstChild;!e||(e.value=this._value)}async hydrate(e){e.characterClass!==this._characterClass&&(this._characterClass=e.characterClass,await this.render())}connectedCallback(){this.render().then(()=>s.subscribe(this.hydrate.bind(this)))}disconnectedCallback(){s.unsubscribe(this.hydrate.bind(this))}async render(){if(!!this._characterClass)return new Promise(e=>{setTimeout(async()=>{switch(this._characterClass){case i.Fighter:await import("./fighter-moves-4NKCQ6Y5.js"),this.innerHTML="<dw-fighter-moves></dw-fighter-moves>";break;case i.Ranger:await import("./ranger-moves-TXJ7IJBI.js"),this.innerHTML="<dw-ranger-moves></dw-ranger-moves>";break;case i.Bard:await import("./bard-moves-FBTZ3HMP.js"),this.innerHTML="<dw-bard-moves></dw-bard-moves>";break;case i.Druid:await import("./druid-moves-GXVGQGWO.js"),this.innerHTML="<dw-druid-moves></dw-druid-moves>";break;case i.Paladin:await import("./paladin-moves-GKDZ2ZYF.js"),this.innerHTML="<dw-paladin-moves></dw-paladin-moves>";break;case i.Thief:await import("./thief-moves-EVGY7VNU.js"),this.innerHTML="<dw-thief-moves></dw-thief-moves>";break;case i.Cleric:await import("./cleric-moves-QA2WQLXR.js"),this.innerHTML="<dw-cleric-moves></dw-cleric-moves>";break;case i.Wizard:await import("./wizard-moves-5JOKS3PC.js"),this.innerHTML="<dw-wizard-moves></dw-wizard-moves>";break;default:await import("./other-moves-GSRZACE6.js"),this.innerHTML="<dw-other-moves></dw-other-moves>";break}this.updateDom(),e()})})}};customElements.define("dw-character-moves",A);var V=`<div class="flex flex-col">
...
>
  ...
  >
    ...
    >
      ...
      <a id="character-form-link" href="#character-form" class="text-left mx-2">
        Character Sheet
      </a>
      <a
