...
`;var M=class extends HTMLElement{constructor(){super();s(this,"hydrate",e=>{let t=this.querySelector("#coin");t.value=e.coin||0})}static get observedAttributes(){return["value"]}attributeChangedCallback(e,t,r){e==="value"&&(this.querySelector("#coin").innerHTML=r)}connectedCallback(){this.render(),o.subscribe(this.hydrate),this.querySelector("#coin").addEventListener("change",t=>{o.coin=t.target.value})}disconnectedCallback(){o.unsubscribe(this.hydrate),this.querySelector("#coin").removeEventListener("change",t=>{o.coin=t.target.value})}render(){this.innerHTML=G}};customElements.define("dw-character-coin",M);var z=`<div>\r
  <dw-section-header>\r
...
`;var T=class extends HTMLElement{constructor(){super();s(this,"hydrate",e=>{this.querySelector("#gear-list").value=e.gear||[],this.querySelector("#load").value=e.load||0,this.querySelector("#max-load").value=e.maxLoad||0})}onUpdate(e){o.gear=e.detail}connectedCallback(){this.render(),o.subscribe(this.hydrate),this.querySelector("#gear-list").addEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").addEventListener("change",e=>{o.load=e.target.value}),this.querySelector("#max-load").addEventListener("change",e=>{o.maxLoad=e.target.value})}disconnectedCallback(){o.unsubscribe(this.hydrate),this.querySelector("#gear-list").removeEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").removeEventListener("change",e=>{o.load=e.target.value}),this.querySelector("#max-load").removeEventListener("change",e=>{o.maxLoad=e.target.value})}render(){this.innerHTML=z}};customElements.define("dw-character-gear",T);var O=class extends HTMLElement{constructor(){super();s(this,"_characterClass");s(this,"_value",{})}get value(){return this._value}set value(e){this._value=e,this.updateDom()}updateDom(){let e=this.firstChild;!e||(e.value=this._value)}async hydrate(e){e.characterClass!==this._characterClass&&(this._characterClass=e.characterClass,await this.render())}connectedCallback(){this.render(),o.subscribe(this.hydrate.bind(this))}disconnectedCallback(){o.unsubscribe(this.hydrate.bind(this))}async render(){switch(this._characterClass){case c.Fighter:await import("./fighter-moves-DXXA2LBU.js"),this.innerHTML="<dw-fighter-moves></dw-fighter-moves>";break;case c.Ranger:await import("./ranger-moves-DMNABW25.js"),this.innerHTML="<dw-ranger-moves></dw-ranger-moves>";break;default:this.innerHTML="";break}this.updateDom()}};customElements.define("dw-character-moves",O);var B=`<div class="flex flex-col">\r
...
<link rel="stylesheet" href="tailwind.css" />\r
`;var R=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get observedAttributes(){return["for","icon-class"]}attributeChangedCallback(a,e,t){let r=this.shadowRoot.querySelector("#labeled-decorate-input__input");switch(a){case"for":this.shadowRoot.querySelector("#labeled-decorate-input__label")?.setAttribute("for",t);break;case"icon-class":this.shadowRoot.querySelector("#labeled-decorated-input__icon")?.classList.add(t);break;default:break}}onMount(){let a=this.shadowRoot.querySelector("#labeled-decorated-input__icon"),e=this.shadowRoot.querySelector("#labeled-decorate-input__label");a.classList.add(this.getAttribute("icon-class")),e.setAttribute("for",this.getAttribute("for"))}connectedCallback(){this.render(),this.onMount()}render(){this.shadowRoot.innerHTML=J}};customElements.define("dw-labeled-decorated-input",R);var H=class extends HTMLElement{constructor(){super();s(this,"_characterClass");s(this,"_inputs",[["armor","armor"],["hit-points","hitPoints"],["max-hit-points","maxHitPoints"]]);s(this,"onArmorChange",e=>{o.armor=e.target.value});s(this,"onHitPointsChange",e=>{o.hitPoints=e.target.value});s(this,"onMaxHitPointsChange",e=>{o.maxHitPoints=e.target.value});s(this,"onChange",e=>{let{name:t}=e.target;switch(t){case"armor":this.onArmorChange(e);break;case"hit-points":this.onHitPointsChange(e);break;case"max-hit-points":this.onMaxHitPointsChange(e);break;default:break}});s(this,"hydrate",e=>{if(this._characterClass!==e.characterClass){this._characterClass=e.characterClass;let t=this.querySelector("#damage-input");t&&(t.innerHTML=this.getDiceAmount())}this._inputs.forEach(([t,r])=>{let i=this.querySelector(`#${t}`);i.value=e[r]||0})});s(this,"onMount",()=>{o.subscribe(this.hydrate),this._inputs.forEach(([e])=>{this.querySelector(`#${e}`).addEventListener("change",this.onChange)})});s(this,"beforeUnmount",()=>{o.unsubscribe(this.hydrate),this._inputs.forEach(([e])=>{this.querySelector(`#${e}`).removeEventListener("dw-input-change",this.onChange)})})}getDiceAmount(){switch(this._characterClass){case c.Fighter:return"D10";case c.Ranger:return"D8";default:return"D?"}}connectedCallback(){this.render(),this.onMount()}disconnectedCallback(){this.beforeUnmount()}render(){this.innerHTML=B;let e=this.querySelector("#damage-input");e&&(e.innerHTML=this.getDiceAmount())}};customElements.define("dw-character-armor-hp-damage",H);var A=class extends HTMLElement{constructor(){super();s(this,"onCharacterNameChange",e=>{o.characterName=e.target.value});s(this,"onLevelChange",e=>{o.level=e.target.value});s(this,"onXpChange",e=>{o.xp=e.target.value});s(this,"onMovesChange",e=>{o.moves=e.detail});s(this,"hydrate",e=>{let t=this.querySelector("#character-name"),r=this.querySelector("#level"),i=this.querySelector("#xp"),l=this.querySelector("dw-character-moves");t.value=e.characterName||"",r.value=e.level||"",i.value=e.xp||0,l.value=e.moves||{}})}connectedCallback(){this.render(),o.subscribe(this.hydrate);let e=this.querySelector("#character-name"),t=this.querySelector("#level"),r=this.querySelector("#xp"),i=this.querySelector("dw-character-moves");e.addEventListener("change",this.onCharacterNameChange),t.addEventListener("change",this.onLevelChange),r.addEventListener("change",this.onXpChange),i.addEventListener("dw-character-moves-change",this.onMovesChange)}disconnectedCallback(){o.unsubscribe(this.hydrate);let e=this.querySelector("#character-name"),t=this.querySelector("#level"),r=this.querySelector("dw-character-moves");e.removeEventListener("change",this.onCharacterNameChange),t.removeEventListener("change",this.onLevelChange),xpElement.removeEventListener("change",this.onXpChange),r.removeEventListener("dw-character-moves-change",this.onMovesChange)}render(){this.innerHTML=D}};customElements.define("dw-character-form",A);var X=`<style>\r
  .banner .arrow-up {\r
    width: 100%;\r
    height: 20px;\r
...
>\r
  ...
  >\r
    ...
    >\r
      ...
      <a href="#player-moves" class="text-left mx-2">Player Moves</a>\r
      <input\r
...
<link rel="stylesheet" href="tailwind.css" />\r
`;var W=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}disconnectedCallback(){}render(){this.shadowRoot.innerHTML=K}};customElements.define("dw-player-moves",W);
