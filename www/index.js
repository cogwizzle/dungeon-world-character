import"./chunk-7Z555Q4H.js";import{a as s}from"./chunk-YJ2DKIZS.js";var P=`<form id="character-form" class="my-4 overflow-x-hidden lg:overflow-x-auto">\r
...
`)}
  ...
  </div>`,g=class extends HTMLElement{constructor(){super();s(this,"_options",[]);s(this,"_title","")}static get observedAttributes(){return["options","title"]}attributeChangedCallback(e,t,o){switch(e){case"options":this._options=JSON.parse(o)||[],this.render();break;case"title":this._title=o||"",this.render();break;default:break}}connectedCallback(){this.render()}disconnectedCallback(){}render(){this.innerHTML=ae({title:this._title,options:this._options})}};customElements.define("dw-character-look-group",g);var w=class extends HTMLElement{constructor(){super();s(this,"_characterClass");s(this,"onChange",e=>{let{name:t,value:o}=e.target;this[`_${t}`]=o,this.emit()});s(this,"hydrate",async e=>{let t=e.look||{};this._characterClass!==e.characterClass&&(this.beforeUnmount(),this._characterClass=e.characterClass,await this.render(),this.onMount()),this.groups.forEach(i=>{this[`_${i}`]=t[i]||"";let c=[...this.querySelectorAll(`[name="${i}"][type="radio"]`)];c.forEach(d=>{d.checked=d.value===t[i]});let h=this.querySelector(`#${i}-other`);h.value=c.every(d=>d.value!==t[i])&&t[i]?t[i]:""})})}get groups(){switch(this._characterClass){case n.Fighter:return["body","eyes","hair","skin"];case n.Ranger:case n.Bard:case n.Thief:return["body","eyes","hair","clothes"];case n.Druid:return["hair","eyes","clothes"];case n.Paladin:return["body","eyes","hair","holy-symbol"];default:return[]}}emit(){switch(this._characterClass){case n.Fighter:r.look={body:this._body,eyes:this._eyes,hair:this._hair,skin:this._skin};break;case n.Ranger:case n.Bard:case n.Thief:r.look={body:this._body,eyes:this._eyes,hair:this._hair,clothes:this._clothes};break;case n.Druid:r.look={hair:this._hair,eyes:this._eyes,clothes:this._clothes};break;case n.Paladin:r.look={body:this._body,eyes:this._eyes,hair:this._hair,"holy-symbol":this["_holy-symbol"]};default:break}}onMount(){r.subscribe(this.hydrate),this.groups.reduce((t,o)=>[...t,...this.querySelectorAll(`[name="${o}"]`)],[]).forEach(t=>t.addEventListener("change",this.onChange))}beforeUnmount(){r.unsubscribe(this.hydrate),this.groups.reduce((t,o)=>[...t,...this.querySelectorAll(`[name="${o}"]`)],[]).forEach(t=>t.removeEventListener("change",this.onChange))}connectedCallback(){this.render(),this.onMount()}disconnectedCallback(){this.beforeUnmount()}async render(){switch(this._characterClass){case n.Fighter:let e=await import("./fighter-look-RVNWJ37O.js");this.innerHTML=e.default;break;case n.Ranger:let t=await import("./ranger-look-7XLKCARA.js");this.innerHTML=t.default;break;case n.Bard:let o=await import("./bard-look-MILTANGH.js");this.innerHTML=o.default;break;case n.Druid:let i=await import("./druid-look-FI3P5NUG.js");this.innerHTML=i.default;break;case n.Paladin:let c=await import("./paladin-look-UDG6CTYU.js");this.innerHTML=c.default;break;case n.Thief:let h=await import("./thief-look-BA42AVT6.js");this.innerHTML=h.default;break;default:break}}};customElements.define("dw-character-look",w);var se=({title:l,options:a})=>p`<div class="flex flex-col">
...
<link rel="stylesheet" href="tailwind.css" />\r
`;var j=(l,a)=>{let e=document.createElement("template"),t="bg-transparent border-b-2 border-b-black outline-none w-full";return e.innerHTML=`<input type="text" value="${l}" id="item-${a}" class="${t}" />`,e.content.firstChild},L=class extends HTMLElement{constructor(){super();s(this,"_value",[]);s(this,"onUpdate",async(e,t)=>{let o=e.target.value;if(this._value[t]=o,o===""){let i=this._value;this._value=this._value.filter((c,h)=>h!==t),this.renderList(i,this._value)}this.dispatchEvent(new CustomEvent("dw-infinite-list-change",{detail:this._value}))});s(this,"onAdd",e=>{let t=this._value.length;this._value=[...this._value,e],this.shadowRoot.querySelector("#new").value="";let o=j(e,t);o.setAttribute("value",e),this.shadowRoot.querySelector("#list").insertBefore(o,this.shadowRoot.querySelector("#new")),o.setSelectionRange(o.value.length,o.value.length),o.addEventListener("keyup",i=>{this.onUpdate(i,t)}),o.focus(),this.dispatchEvent(new CustomEvent("dw-infinite-list-change",{detail:this._value}))});this.attachShadow({mode:"open"})}get value(){return this._value}set value(e){this.renderList(this._value,e),this._value=e}diff(e,t){let[o,i]=t.reduce(([h,d],u,f)=>(f<e.length&&e[f]!==u&&d.push(f),f>=e.length&&h.push(u),[h,d]),[[],[]]);return{removed:e.reduce((h,d,u)=>(t[u]||h.push(u),h),[]),added:o,modified:i}}renderList(e=[],t=[]){let{removed:o,added:i,modified:c}=this.diff(e,t),h=this.shadowRoot.querySelector("#list");o.forEach(d=>{let u=this.shadowRoot.querySelector(`#item-${d}`);u&&(u.removeEventListener("keyup",f=>this.onUpdate(f,d)),u.remove())}),c.forEach(d=>{let u=this.shadowRoot.querySelector(`#item-${d}`);u&&(u.value=t[d])}),i.forEach((d,u)=>{let f=j(d,e.length+u);f.addEventListener("keyup",V=>this.onUpdate(V,u)),h.insertBefore(f,this.shadowRoot.querySelector("#new"))})}connectedCallback(){this.render(),this.shadowRoot.querySelector("#new").addEventListener("keyup",e=>this.onAdd(e.target.value))}disconnectedCallback(){this.shadowRoot.querySelector("#new").removeEventListener("keyup",e=>this.onAdd(e.target.value)),this._value.forEach((e,t)=>{document.querySelector(`#item-${t}`).removeEventListener("keyup",i=>this.onUpdate(i,t))})}render(){this.shadowRoot.innerHTML=I,this.renderList([],this._value)}};customElements.define("dw-infinite-list",L);var S=class extends HTMLElement{constructor(){super();s(this,"hydrate",e=>{this.querySelector("#bonds-list").value=e.bonds})}onUpdate(e){r.bonds=e.detail}connectedCallback(){this.render(),r.subscribe(this.hydrate),this.querySelector("#bonds-list").addEventListener("dw-infinite-list-change",this.onUpdate)}disconnectedCallback(){r.unsubscribe(this.hydrate),this.querySelector("#bonds-list").removeEventListener("dw-infinite-list-change",this.onUpdate)}render(){this.innerHTML=N}};customElements.define("dw-character-bonds",S);var B=`<dw-vertical-selection id="race" title="race"></dw-vertical-selection>\r
`;var m=(l,a)=>({name:l,description:a}),M=class extends HTMLElement{constructor(){super();s(this,"_characterClass");s(this,"onChange",e=>{r.race=e.detail.value});s(this,"hydrate",e=>{this._characterClass!==e.characterClass&&(this._characterClass=e.characterClass,this.querySelector("#race").setAttribute("value",e.race),this.updateOptions())})}get options(){switch(this._characterClass){case n.Fighter:return[m("dwarf","When you share a drink with someone, you may parley with them using CON instead of CHA."),m("elf","Choose one weapon-you can always treat weapons of that type as if they had the precise tag."),m("halfling","Choose one weapon-you can always treat weapons of that type as if they had the precise tag."),m("human","Once per battle you may reroll a single damage roll (yours or someone else's")];case n.Ranger:return[m("elf","When you Undertake A Perilous Journey through wilderness whatever job you take you succeed as if you rolled a 10+."),m("human","When you Make Camp in a dungeon or city, you don't need to consume a ration.")];case n.Bard:return[m("elf","When you enter an important location (your call) you can ask the GM for one fact from the history of that location."),m("human","When you first enter a civilized settlement someone who respects the custom of hospitality to minstrels will take you in as their guest.")];case n.Druid:return[m("elf","The sap of the elder trees flows within you. In addition to any other attunements, the Great Forest is always considered your land."),m("human","As your people learned to bind animals to field and farm, so too are you bound to them. You may always take the shape of any domesticated animal, in addition to your normal options."),m("halfling","You sing the healing songs of spring and brook. When you make camp, you and your allies heal +1d6.")];case n.Paladin:return[m("human","When you pray for guidance, even for a moment and ask \u201Cwhat here is evil?\u201D the GM will tell you, honestly.")];case n.Thief:return[m("halfling","When you attack with a ranged weapon, deal +2 damage."),m("human","You are a professional. When you Spout Lore or Discern Realities about criminal activities, take +1.")];default:return[]}}connectedCallback(){this.render(),r.subscribe(this.hydrate),this.querySelector("#race").addEventListener("dw-change",this.onChange)}disconnectedCallback(){r.unsubscribe(this.hydrate),this.querySelector("#race").addEventListener("dw-change",this.onChange)}updateOptions(){this.querySelector("#race").setAttribute("options",JSON.stringify(this.options))}render(){this.innerHTML=B,this.updateOptions()}};customElements.define("dw-character-race",M);var G=`<style>\r
  .coin {\r
    top: -0.4rem;\r
  }\r
</style>\r
...
`;var T=class extends HTMLElement{constructor(){super();s(this,"hydrate",e=>{this.querySelector("#gear-list").value=e.gear||[],this.querySelector("#load").value=e.load||0,this.querySelector("#max-load").value=e.maxLoad||0})}onUpdate(e){r.gear=e.detail}connectedCallback(){this.render(),r.subscribe(this.hydrate),this.querySelector("#gear-list").addEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").addEventListener("change",e=>{r.load=e.target.value}),this.querySelector("#max-load").addEventListener("change",e=>{r.maxLoad=e.target.value})}disconnectedCallback(){r.unsubscribe(this.hydrate),this.querySelector("#gear-list").removeEventListener("dw-infinite-list-change",this.onUpdate),this.querySelector("#load").removeEventListener("change",e=>{r.load=e.target.value}),this.querySelector("#max-load").removeEventListener("change",e=>{r.maxLoad=e.target.value})}render(){this.innerHTML=z}};customElements.define("dw-character-gear",T);var H=class extends HTMLElement{constructor(){super();s(this,"_characterClass");s(this,"_value",{})}get value(){return this._value}set value(e){this._value=e,this.updateDom()}updateDom(){let e=this.firstChild;!e||(e.value=this._value)}async hydrate(e){e.characterClass!==this._characterClass&&(this._characterClass=e.characterClass,await this.render())}connectedCallback(){this.render(),r.subscribe(this.hydrate.bind(this))}disconnectedCallback(){r.unsubscribe(this.hydrate.bind(this))}async render(){switch(this._characterClass){case n.Fighter:await import("./fighter-moves-JMG7GJM4.js"),this.innerHTML="<dw-fighter-moves></dw-fighter-moves>";break;case n.Ranger:await import("./ranger-moves-56XTQVP6.js"),this.innerHTML="<dw-ranger-moves></dw-ranger-moves>";break;case n.Bard:await import("./bard-moves-CVR2RZU3.js"),this.innerHTML="<dw-bard-moves></dw-bard-moves>";break;case n.Druid:await import("./druid-moves-VKSIF6LA.js"),this.innerHTML="<dw-druid-moves></dw-druid-moves>";break;case n.Paladin:await import("./paladin-moves-Q7NMLDLV.js"),this.innerHTML="<dw-paladin-moves></dw-paladin-moves>";break;case n.Thief:await import("./thief-moves-ZZ7LZ7FA.js"),this.innerHTML="<dw-thief-moves></dw-thief-moves>";break;default:this.innerHTML="";break}this.updateDom()}};customElements.define("dw-character-moves",H);var Y=`<div class="flex flex-col">\r
