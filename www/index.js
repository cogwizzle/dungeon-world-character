import"./chunk-7Z555Q4H.js";import{a as s}from"./chunk-YJ2DKIZS.js";var D=`<form id="character-form" class="my-4 overflow-x-hidden lg:overflow-x-auto">\r
...
<link rel="stylesheet" href="tailwind.css" />\r
`;var j=(n,a)=>{let e=document.createElement("template"),t="bg-transparent border-b-2 border-b-black outline-none w-full";return e.innerHTML=`<input type="text" value="${n}" id="item-${a}" class="${t}" />`,e.content.firstChild},L=class extends HTMLElement{constructor(){super();s(this,"_value",[]);s(this,"onUpdate",async(e,t)=>{let o=e.target.value;if(this._value[t]=o,o===""){let i=this._value;this._value=this._value.filter((c,d)=>d!==t),this.renderList(i,this._value)}this.dispatchEvent(new CustomEvent("dw-infinite-list-change",{detail:this._value}))});s(this,"onAdd",e=>{let t=this._value.length;this._value=[...this._value,e],this.shadowRoot.querySelector("#new").value="";let o=j(e,t);o.setAttribute("value",e),this.shadowRoot.querySelector("#list").insertBefore(o,this.shadowRoot.querySelector("#new")),o.setSelectionRange(o.value.length,o.value.length),o.addEventListener("keyup",i=>{this.onUpdate(i,t)}),o.focus(),this.dispatchEvent(new CustomEvent("dw-infinite-list-change",{detail:this._value}))});this.attachShadow({mode:"open"})}get value(){return this._value}set value(e){this.renderList(this._value,e),this._value=e}diff(e,t){let[o,i]=t.reduce(([d,h],u,m)=>(m<e.length&&e[m]!==u&&h.push(m),m>=e.length&&d.push(u),[d,h]),[[],[]]);return{removed:e.reduce((d,h,u)=>(t[u]||d.push(u),d),[]),added:o,modified:i}}renderList(e=[],t=[]){let{removed:o,added:i,modified:c}=this.diff(e,t),d=this.shadowRoot.querySelector("#list");o.forEach(h=>{let u=this.shadowRoot.querySelector(`#item-${h}`);u&&(u.removeEventListener("keyup",m=>this.onUpdate(m,h)),u.remove())}),c.forEach(h=>{let u=this.shadowRoot.querySelector(`#item-${h}`);u&&(u.value=t[h])}),i.forEach((h,u)=>{let m=j(h,e.length+u);m.addEventListener("keyup",V=>this.onUpdate(V,u)),d.insertBefore(m,this.shadowRoot.querySelector("#new"))})}connectedCallback(){this.render(),this.shadowRoot.querySelector("#new").addEventListener("keyup",e=>this.onAdd(e.target.value))}disconnectedCallback(){this.shadowRoot.querySelector("#new").removeEventListener("keyup",e=>this.onAdd(e.target.value)),this._value.forEach((e,t)=>{document.querySelector(`#item-${t}`).removeEventListener("keyup",i=>this.onUpdate(i,t))})}render(){this.shadowRoot.innerHTML=I,this.renderList([],this._value)}};customElements.define("dw-infinite-list",L);var S=class extends HTMLElement{constructor(){super();s(this,"hydrate",e=>{this.querySelector("#bonds-list").value=e.bonds})}onUpdate(e){r.bonds=e.detail}connectedCallback(){this.render(),r.subscribe(this.hydrate),this.querySelector("#bonds-list").addEventListener("dw-infinite-list-change",this.onUpdate)}disconnectedCallback(){r.unsubscribe(this.hydrate),this.querySelector("#bonds-list").removeEventListener("dw-infinite-list-change",this.onUpdate)}render(){this.innerHTML=N}};customElements.define("dw-character-bonds",S);var B=`<dw-vertical-selection id="race" title="race"></dw-vertical-selection>\r
