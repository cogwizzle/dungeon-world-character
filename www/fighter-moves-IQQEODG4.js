import{a as o}from"./chunk-6TNH6BCR.js";import"./chunk-LU7DNXH4.js";import{a as e,b as i}from"./chunk-2DL6MCQC.js";var l=i`<div>
  ...
  <div class="grid grid-cols-2 gap-2">
    <div class="grid grid-cols-1 lg:grid-cols-2 col-span-2 gap-1">
      ...
      <div class="pl-8 lg:pl-0 col-span-2 lg:col-span-1">
  ...
  <div class="grid grid-cols-2 gap-2">
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="merciless" name="merciless" />
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="heirloom" name="heirloom" />
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="seeing-red" name="seeing-red" />
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="blacksmith" name="blacksmith" />
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="iron-hide" name="iron-hide" />
  ...
  <div class="grid grid-cols-2 gap-2">
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="evil-eye" name="evil-eye" />
    ...
    <div class="flex flex-col col-span-1">
      <div class="flex flex-row">
        <input type="checkbox" id="steel-hide" name="steel-hide" />
